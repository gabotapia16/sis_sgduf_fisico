...
<div class="container">
            ...
            <div class="panel-body">
                ...
                <div class="panel panel-default">
                    <div class="table-responsive">
                                  <table class="table">
                                    <tr align="center">
                                      <td><a href="demision/add_dictamen"><img alt="Brand" src="imagenes/add.png" width="50" height="50"></td>
                                      <td><a href="demision/show_dictamen"><img alt="Brand" src="imagenes/view.png" width="50" height="50"></td>
                                    </tr>
                                    <tr align="center">
                                      <td><p>Captura de solcitudes</p></td>
                                      <td><p>Ver solicitudes</p></td>
                                    </tr>
                                    <?php if ($_SESSION["perfil_user"] == "ACCESO_TOTAL" or $_SESSION["perfil_user"] == "ADMINISTRADOR") {
    ?>
                                    <tr align="center">
                                      <td><a href="demision/update_dictamen"><img alt="Brand" src="imagenes/modify.png" width="50" height="50"></td>
                                      <td><a href="demision/dictamenes"><img alt="Brand" src="imagenes/estadistica.png" width="50" height="50"></td>
                                    </tr>
                                    <tr align="center">
                                      <td><p>Editar solicitudes</p></td>
                                      <td><p>Control de Dictamenes</p></td>
                                    </tr>
    ...
    ?>
                                    ...
                                    <?php }?>
                                    <tr align="center">
                                      <td> <a href="demision/grafica.php"><i class="fas fa-chart-line fa-3x"></i></a></td>
                                    </tr>
                                    <tr align="center">
