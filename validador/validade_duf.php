                            ...
                            while($row=mysqli_fetch_array($sql))
                        {
                            ...
                            ?>
                             <table class="table" >
                                        ...
                                        <tr>
                                            <td><p><strong>PROPIETARIO:</p></strong><h3 align="center"><?php echo $PROPIETARIO; ?></h3></td>
                                        </tr>
                                        <tr>
                                            <td><p><strong>DENOMINACIÓN:</p></strong><h3 align="center"><?php echo $DENOMINACION; ?></h3></td>
                                        </tr>
                                        <tr>
                                            <td><p><strong>SUPERFICIE TOTAL:</p></strong><h3 align="center"><?php echo $SUPERFICIE_TOTAL. " m²"; ?></h3></td>
                                        </tr>
                                        <tr>
                                            <td><p><strong>SUPERFICIE CONSTRUIDA:</p></strong><h3 align="center"><?php echo $SUPERFICIE_CONSTRUIDA. " m²"; ?></h3></td>
                                        </tr>
                                        <tr>
                                            <td><p><strong>SUPERFICIE EN USO:</p></strong><h3 align="center"><?php echo $SUPERFICIE_USO. " m²"; ?></h3></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td><p><strong>GIRO:</p></strong><h4 align="center"><?php echo $GIRO; ?></h4></td>
                                        </tr>
                                        <tr>
                                            <td><p><strong>ACTIVIDAD:</p></strong><h4 align="center"><?php echo $ACTIVIDAD; ?></h4></td>
                                        </tr>
                                        <tr>
                                            <td><p><strong>DIAS Y HORARIOS:</p></strong><h4 align="center"><?php echo $DIAS_HORARIOS; ?></h4></td>
                                        </tr>
                                        <tr>
                                            <td><p><strong>EVALUACIONES OBTENIDAS:</p></strong><h4 align="center"><?php echo $EVALUACIONES; ?></h4></td>
                                        </tr>
                                        <tr>
                                            <td><p><strong>FECHA EXPEDICIÓN:</p></strong><h4 align="center"><?php echo $FECHA_EXPEDICION; ?></h4></td>
                                        </tr>
                                        <tr>
                                            <td><p><strong>FECHA ENTREGA:</p></strong><h4 align="center"><?php echo $FECHA_ENTREGA; ?></h4></td>
                                        </tr>
                                        <?php 
                                            if ($FEDEERRATAS != "") {?>
                                                <tr>
                                                    <td><p><strong>DICTAMEN CON FE DE ERRATAS</p></strong><h4 align="center"><?php echo $FEDEERRATAS; ?></h4></td>
                                                </tr>
                                           <?php }?>
                        ...
                        while($row=mysqli_fetch_array($sql))
                        {
                            ...
                            ?>
                             <table class="table" >
                                        ...
                                        <?php 
                                            if ($FEDEERRATAS != "" AND $FECHA_FEDEERRATAS != "") {?>
                                                <tr>
                                                    <td><p><strong>DICTAMEN CON FE DE ERRATAS:</p></strong><h4 align="center"><?php echo $FEDEERRATAS; ?></h4></td>
                                                </tr>
                                                <tr>
                                                    <td><p><strong>FECHA DE ELABORACIÓN DE LA FE DE ERRATAS:</p></strong><h4 align="center"><?php echo $FECHA_FEDEERRATAS; ?></h4></td>
                                                </tr>
                                           <?php }?>
                                    </table>
                            <?php  
