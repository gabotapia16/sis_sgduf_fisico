				...
				<tbody>
					<?php foreach ($sql as $fila): ?>
						<tr style="text-align:center">
							...
							<td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" onclick="cachaCorreo('<?php echo $fila['correo_propietario'] ?>', '<?php echo $fila['correo_rep_legal'] ?>', '<?php echo $fila['deno_proyecto'] ?>', '<?php echo $fila['domicilio_proyecto'] ?>', '<?php echo $fila['municipio_proyecto'] ?>', '<?php echo $fila['cp_proyecto'] ?>')"><i class="far fa-clipboard fa-lg"></i>
								</button>
							</td>
