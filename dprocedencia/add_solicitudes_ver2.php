        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group col">
              ...
              <br>
              <select class="js-example-basic-single col-md-12" id='id_selectGiro' required>
                <option value="" selected hidden>Seleccione una opción</option>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group col">
              ...
              <br>
              <input type="number" class="col-md-5 form-control" name="" pattern="^[0-9]+" id="id_codigoPostal" min="50000" max="57999" >
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group col">
