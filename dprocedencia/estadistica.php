...
$totalProcedencia=
$datos_cofaem_procedencia_notificados['total'] +$datos_cofaem_procedencia_sin_notificar['total'] +
$datos_cofaem_prevencion_notificados['total'] +$datos_cofaem_prevencion_sin_notificar['total'] +
$datos_cofaem_analisis['total']
+$datos_dgou_procedencia_notificados['total'] +$datos_dgou_procedencia_sin_notificar['total'] +
$datos_dgou_prevencion_notificados['total'] +$datos_dgou_prevencion_sin_notificar['total'] +
