    ...
    <form class="was-validated" id="myForm">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group col">
              ...
              <br>
              <select class="js-example-basic-single" name="id_selectCaja" id='id_selectCaja' required>
                <option value="" selected hidden>Seleccione una opción</option>
      ...
      <div class="container p-3 mb-2 bg-light text-dark">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group col">
              <center><label>SUPERFICIE CONSTRUIDA (m²):</label></center>
              <br>
    ...
    <form id="myForm2">
      <div class="container p-3 mb-2 bg-light text-dark">
        ...
        <div class="container p-3 mb-2 bg-light text-dark">
          ...
          <div class="p-3 mb-2 bg-info text-white">
            <center><h3>EN EL CASO DE QUE EL EXPEDIENTE SE REQUIERA TURNAR EL EXPEDIENTE A ETAPA 2, SELECCIONAR EL CHECK, DE LO CONTRARIO SOLO DAR CLIC EN FINALIZAR CAPTURA</h3></center>
          </div>
          <div class="row">
  ...
  <script>
    ...
    function guardar(){
      ...
      .done(function(datos) {
        ...
        swal("Éxito!", "Los datos Generales del expediente se han guardado correctamente, por favor ingrese los datos correspondientes a la Etapa 1 del mismo", "CONTINUAR");
      })
