...
WHERE pi.estado_procencia='CON PROCEDENCIA NOTIFICADA' AND dt.origen_ingreso='COFAEM' AND pi.estado_etapa='confirmado'
");
$sql_cofaem_procedencia_sin_notificar = mysqli_query($conection, "SELECT COUNT(dt.nombre_propietario) as total
FROM datos_generales dt
INNER JOIN procedencia_integracion pi ON dt.id = pi.id_datos_generales
WHERE pi.estado_procencia='CON PROCEDENCIA SIN NOTIFICAR' AND dt.origen_ingreso='COFAEM' AND pi.estado_etapa='confirmado'
");
$sql_dgou_procedencia_notificados = mysqli_query($conection, "SELECT COUNT(dt.nombre_propietario) as total
FROM datos_generales dt
INNER JOIN procedencia_integracion pi ON dt.id = pi.id_datos_generales
WHERE pi.estado_procencia='CON PROCEDENCIA NOTIFICADA' AND dt.origen_ingreso='dgou' AND pi.estado_etapa='confirmado'
");
$sql_dgou_procedencia_sin_notificar = mysqli_query($conection, "SELECT COUNT(dt.nombre_propietario) as total
FROM datos_generales dt
INNER JOIN procedencia_integracion pi ON dt.id = pi.id_datos_generales
WHERE pi.estado_procencia='CON PROCEDENCIA SIN NOTIFICAR' AND dt.origen_ingreso='dgou' AND pi.estado_etapa='confirmado'
");
//***************************************************************************************
...
FROM datos_generales dt
INNER JOIN procedencia_integracion pi ON dt.id = pi.id_datos_generales
WHERE pi.estado_prevencion='CON PREVENCION NOTIFICADA' AND dt.origen_ingreso='COFAEM' AND pi.estado_etapa='confirmado'
");
$sql_cofaem_prevencion_sin_notificar = mysqli_query($conection, "SELECT COUNT(dt.nombre_propietario) as total
FROM datos_generales dt
INNER JOIN procedencia_integracion pi ON dt.id = pi.id_datos_generales
WHERE pi.estado_prevencion='CON PREVENCION SIN NOTIFICAR' AND dt.origen_ingreso='COFAEM' AND pi.estado_etapa='confirmado'
");
$sql_dgou_prevencion_notificados = mysqli_query($conection, "SELECT COUNT(dt.nombre_propietario) as total
FROM datos_generales dt
INNER JOIN procedencia_integracion pi ON dt.id = pi.id_datos_generales
WHERE pi.estado_prevencion='CON PREVENCION NOTIFICADA' AND dt.origen_ingreso='dgou' AND pi.estado_etapa='confirmado'
");
$sql_dgou_prevencion_sin_notificar = mysqli_query($conection, "SELECT COUNT(dt.nombre_propietario) as total
FROM datos_generales dt
INNER JOIN procedencia_integracion pi ON dt.id = pi.id_datos_generales
WHERE pi.estado_prevencion='CON PREVENCION SIN NOTIFICAR' AND dt.origen_ingreso='dgou' AND pi.estado_etapa='confirmado'
");
//***************************************************************************************
...
FROM datos_generales dt
INNER JOIN procedencia_integracion pi ON dt.id = pi.id_datos_generales
WHERE pi.estado_prevencion!='CON PREVENCION NOTIFICADA' AND pi.estado_prevencion!='CON PREVENCION SIN NOTIFICAR' AND pi.estado_procencia!='CON PROCEDENCIA SIN NOTIFICAR' AND pi.estado_procencia!='CON PROCEDENCIA NOTIFICADA' AND dt.origen_ingreso='COFAEM' AND pi.estado_etapa='confirmado'
");
$sql_dgou_analisis = mysqli_query($conection, "SELECT COUNT(dt.nombre_propietario) as total
FROM datos_generales dt
INNER JOIN procedencia_integracion pi ON dt.id = pi.id_datos_generales
WHERE pi.estado_prevencion!='CON PREVENCION NOTIFICADA' AND pi.estado_prevencion!='CON PREVENCION SIN NOTIFICAR' AND pi.estado_procencia!='CON PROCEDENCIA SIN NOTIFICAR' AND pi.estado_procencia!='CON PROCEDENCIA NOTIFICADA' AND dt.origen_ingreso='DGOU' AND pi.estado_etapa='confirmado'
");
//*************************************************************************************
