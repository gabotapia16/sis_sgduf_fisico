...
include '../menu.php';
 ?>
	...
	<script>
		...
		function turnarFirma(id_general, id_etapa1){
			Swal.fire({
				title: '¿Está seguro(a)?',
				text: "¿Desea Turnar el Expediente Para Firma?",
				icon: 'info',
		...
		function generaFolio(id_general, id_emision){
			$.ajax({
				url: 'generar_folio.php',
				type: 'POST',
				dataType: 'JSON',
				data: {
					id_general: id_general,
