                  ...
                  <div class=table-responsive>
                   ...
                   <table class=table>
                     <tr>
                         ...
                         <th><h6 align=center>SUPERFICIE EN USO</h6></th>
                         ...
                         <th><h6 align=centerGENERAR</h6></th>
                    </tr>";           
                  ...
                  case 'CAPTURADO':
                      switch ($row['TIPO_DUF']) {
                                case 'NORMAL':
                                  ...
                                  <td><h6>".$row['SUPERFICIE_USO']."</h6></td>
                                  ...
                                  echo "<td><a href="."update_gduf?ID=".base64_encode($row['ID'])."><button type='button' onclick='return confirmar1()' class='btn btn-dark'><span class='glyphicon glyphicon-file'></span></button></a></td>";
